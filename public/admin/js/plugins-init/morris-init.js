	...
	var dlabMorris = function(){
		...
		var donutChart = function(){
			Morris.Donut({
				...
				resize: true,
				redraw: true,
				colors: ['#0869E1', 'rgb(98, 126, 234)', '#ffaa2b'],
				//responsive:true,
		...
		var lineChart = function(){
			...
			let line = new Morris.Line({
				...
				lineColors: ['rgb(8, 105, 225,1)'], //here
				lineWidth: 1,
				hideHover: 'auto',
				pointSize: 0,
				axes: false
		...
		var lineChart2 = function(){
			...
			Morris.Area({
				...
				pointSize: 3,
				fillOpacity: 0,
				pointStrokeColors: ['#EE3C3C', '#ffaa2b', '#0869E1'],
				behaveLikeLine: true,
				gridLineColor: 'transparent',
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(238, 60, 60)', 'rgb(0, 171, 197)', '#0869E1'],
				resize: true
		...
		var barChart = function(){
			...
			//bar chart
				Morris.Bar({
					...
					ykeys: ['a', 'b', 'c'],
					labels: ['A', 'B', 'C'],
					barColors: ['#0869E1', '#627eea', '#ff9f00'],
					hideHover: 'auto',
					gridLineColor: 'transparent',
					resize: true,
					barSizeRatio: 0.25,
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#0869E1', 'rgb(98, 126, 234)', 'rgb(235, 98, 208,1)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
