<div class="nav-header">
    <a href="{{route('admin.dashboard')}}" class="brand-logo">
        <img  class="logo-abbr" src="/admin/images/logo-symbol.png">
                    ...
                    <li class="nav-item">
                        <div class="dropdown header-profile2">
                            <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="header-info2 d-flex align-items-center">
                                    <div class="d-flex align-items-center sidebar-info">
                                        <div>
                                            <h4 class="mb-0">{{ucfirst(auth()->user()->full_name)}}</h4>
                                            <span class="d-block text-end">{{ucfirst(auth()->user()->role)}}</span>
                                        </div>
                                    </div>
                                    <img src="{{!empty(auth()->user()->profile_img) ? '/profiles/'.auth()->user()->profile_img : '/admin/images/user.jpg'}}" alt="">
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end" style="">
                                ...
                                <a href="{{route('setting-account')}}" class="dropdown-item ai-icon ">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
